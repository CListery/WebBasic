package io.clistery.webbasic.demo.viewutils;

import io.clistery.webbasic.demo.MainAct;
import io.clistery.webbasic.demo.feature.SystemWebViewActivity;
import io.clistery.webbasic.demo.feature.VideoActivity;
import io.clistery.webbasic.demo.feature.WebKitWebViewActivity;
import io.clistery.webbasic.demo.feature.WebProcessActivity;
import io.clistery.webbasic.demo.feature.X5WebViewActivity;
...
public class FeatureManager {
    ...
    public static final FeatureItem[] featureItems = {
            makeHeader("基础功能"),
            makeItem("X5BridgeWebView", MainAct.class),
